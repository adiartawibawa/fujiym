<nav id="nav"
    ...
    <div class="flex-none items-stretch flex h-14 lg:hidden">
        <div
            ...
            <span class="inline-flex justify-center items-center w-6 h-6 relative"><svg viewBox="0 0 24 24" width="20"
        ...
        <div
            class="flex items-center grow-0 shrink-0 relative cursor-pointer hover:text-rose-500 text-black dark:text-white py-2 px-3">
            <span class="inline-flex justify-center items-center w-6 h-6"><svg viewBox="0 0 24 24" width="20"
                    height="20" class="inline-block">
                    <path fill="currentColor"
    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <span class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg viewBox="0 0 24 24"
                    ...
                    <!---->
                </span><span class="px-2 transition-colors lg:hidden">Light/Dark</span>
            </div>

            <div
                class="flex items-center grow-0 shrink-0 relative cursor-pointer hover:text-rose-500 text-black dark:text-white py-2 px-3 lg:border-r lg:border-gray-100 lg:dark:border-gray-800 lg:w-16 lg:justify-center">
                <span class="inline-flex justify-center items-center w-6 h-6 relative transition-colors"><svg
                ...
                </span><span class="px-2 transition-colors lg:hidden">Updates</span>
            </div>
            ...
            <div
                ...
                <a
                    ...
                    <div><span>John Doe</span></div><span
                        class="inline-flex justify-center items-center w-6 h-6 lg:inline-flex"><svg viewBox="0 0 24 24"
                            width="16" height="16" class="inline-block">
                ...
                <div
                    class="text-sm border-gray-100 border-b lg:border-b-0 lg:border-gray-200 lg:border-t lg:bg-white lg:absolute lg:top-full lg:left-0 lg:min-w-full lg:z-20 lg:shadow-md lg:rounded-b lg:dark:bg-gray-800 dark:border-gray-700 lg:hidden">
                    <a
                        class="flex items-center grow-0 shrink-0 relative  cursor-pointer hover:text-rose-500 text-black dark:text-white py-2 px-3"><span
                            ...
                            <!---->
                        </span><span class="px-2 transition-colors">My Profile</span></a>
                    <div
                        class="flex items-center grow-0 shrink-0 relative  cursor-pointer hover:text-rose-500 text-black dark:text-white py-2 px-3">
                        <span class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                            ...
                            <!---->
                        </span><span class="px-2 transition-colors">Settings</span>
                    </div>
                    <div
                        class="flex items-center grow-0 shrink-0 relative  cursor-pointer hover:text-rose-500 text-black dark:text-white py-2 px-3">
                        <span class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                            ...
                            <!---->
                        </span><span class="px-2 transition-colors">Messages</span>
                    </div>
                    ...
                    <div
                        ...
                        <span class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                            ...
                            <!---->
                        </span><span class="px-2 transition-colors">Log Out</span>
                    </div>
                </div>
            </div>
