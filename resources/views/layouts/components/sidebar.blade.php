<aside id="aside"
    ...
    <div
        ...
        <div class="flex-1 px-3">
            <b class="uppercase">{{ config('app.name') }}</b>
        </div>
    </div>
    ...
    <div class="flex-1 text-white text-xs">
        ...
        <ul>
            <li>
                <a
                    class="flex cursor-pointer py-2 bg-gradient-to-r hover:from-fuchsia-800 hover:to-rose-500 dark:hover:bg-gray-700"><span
                        class="inline-flex justify-center items-center w-12 h-6 relative flex-none"><svg
                    ...
                    </span><span class="grow">Tables &amp; Lists</span>
                    <!---->
                </a>
                <!---->
            </li>
            ...
            <li>
                <a exact-active-class="bg-gradient-to-r hover:from-fuchsia-800 hover:to-rose-500 dark:bg-gray-700 dark:bg-opacity-70"
